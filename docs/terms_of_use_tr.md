...
Kullanıcı, yüklediği fotoğrafların kendisine ait olduğunu veya bu fotoğrafları kullanma hakkına sahip olduğunu kabul eder.

Uygulama; bitki türü tahmini, sağlık skoru, muhtemel bakım hataları, güvenli bakım adımları, bakım takvimi, sulama hatırlatıcıları ve bitki arşivi sunabilir. Fotoğraf kalitesi, ışık, açı ve bakım cevapları sonucun doğruluğunu etkileyebilir.
...
Hesap ve veri silme talepleri için `delete-account.html`, gizlilik detayları için `privacy.html`, satın alma ve abonelik bilgileri için `purchase-subscriptions.html` sayfaları kullanılmalıdır.
