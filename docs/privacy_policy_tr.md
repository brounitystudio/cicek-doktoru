...
- Google hesabından gelen ad, e-posta ve profil fotoğrafı
- Kullanıcının yüklediği bitki fotoğrafları
- Bitki konumu, son sulama zamanı, ışık, drenaj ve belirti cevapları
- Yapay zeka analiz sonuçları ve bakım önerileri
- Kaydedilen bitkiler, bitki arşivi ve bakım görevleri
- Premium/free plan durumu, kullanım limitleri, reklam ödülü ve analiz hakkı bilgileri
- Bildirim token bilgisi
- Satın alma ve abonelik durumu

Bu veriler; hesap sürekliliği, teşhis geçmişi, bitki takibi, bakım hatırlatıcıları, premium hak yönetimi, reklam ödülleri ve destek süreçleri için kullanılır.
